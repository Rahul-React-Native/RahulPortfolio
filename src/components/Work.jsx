...
export default function Work() {
    ...
    return (
        <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Welcome to my mobile app development portfolio! Explore a collection of projects showcasing my expertise in react native development.</p>
