export default function About() {
    const tools = [
        ...
        { name: 'androidStudio', icon: './assets/androidStudio.png', },
        { name: 'figma', icon: './assets/react.png', },
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='./assets/profile-big.jpeg' alt="" className="w-64 sm:w-80 rounded-3xl max-w-none" />

                    {/* <div className="bg-white w-1/2 aspect-square absolute right-0 bottom-0 rounded-full translate-x-1/4 translate-y-1/3 shadow-[0_4px_55px_rgba(149,0,162,0.15)] flex items-center justify-center">
                        <img src="./assets/roller.png" alt="" className="w-full animate-spin_slow" />
                        <img src="./assets/developer.png" alt="" className="w-2/4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                    </div> */}
                    ...
                    <div className="bg-white w-1/2 aspect-square absolute right-0 bottom-0 rounded-full translate-x-1/4 translate-y-1/3 shadow-[0_4px_55px_rgba(149,0,162,0.15)] flex items-center justify-center overflow-hidden">
                        ...
                        {/* <img src="./assets/roller.png" alt="" className="w-[140%] animate-spin_slow" /> */}

                        {/* Center developer text/image */}
                        <img
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am an experienced react native Developer with over a decade of professional expertise in the field. Throughout my career, I have had the privilege of collaborating with prestigious organizations, contributing to their success and growth.</p>
